...
const TestButton = () => (
	<Column style={{ padding: '10px' }}>
		...
		<Row style={{ padding: '10px', border: '1px solid #ccc' }} align="center space-between">
			<Tooltip style={style} position='left'> LEFT POSITIONED with a super long content </Tooltip>
		</Row>

		<Row style={{ padding: '10px', border: '1px solid #ccc' }} align="center space-between">
			<Tooltip style={style} position='right'> RIGHt POSITIONED with a super long content </Tooltip>
		</Row>

		<Row style={{ padding: '10px', border: '1px solid #ccc' }} align="center space-between">
			<Tooltip style={style} position='top'> TOP POSITIONED with a super long content </Tooltip>
		</Row>

		<Row style={{ padding: '10px', border: '1px solid #ccc' }} align="center space-between">
			<Tooltip style={style} position='bottom'> BOTTOM POSITIONED with a super long content </Tooltip>
		</Row>
