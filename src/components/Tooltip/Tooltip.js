...
class Tooltip extends PureComponent {
  static visibleAfterScroll (element){
    ...
    while(nextElement.parentElement !== null){
      parentRects.push(nextElement.parentElement.getBoundingClientRect());
  ...
  delayShowTooltip() {
    ...
    this.tooltipDelayTimeout = setTimeout(this.showTooltip, this.props.delay);
  }
  delayHideTooltip() {
    ...
    clearTimeout(this.tooltipDelayTimeout);
    this.tooltipDelayTimeout = setTimeout(this.hideTooltip, this.props.delay);
  }
